...
insert=(id,user_name,age,licenceNumber,phoneNumber,status,password,vehicleNumber)=>{
  ...
  console.log("username : "+user_name +" pass "+ password+" image "+id)
       db.transaction(function(tx) {
            tx.executeSql(
              'UPDATE driver_reg set user_name=?, age=?, licence_number=?, phone_number=?, status=?, password=?, vehicle_number=?, image=? where driver_id=?',
              [user_name,age,licenceNumber,phoneNumber,status, password,vehicleNumber,image,id],
              (tx, results) => {
        ...
        <ScrollView
          ...
          style={styles.scrollView}> 
            <View style={styles.viewColor}>
                <Text style={styles.textColor}> Driver Update </Text>
